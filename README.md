...
```css
@import url("https://cdn.jsdelivr.net/gh/JamsRepos/Jamfin@1.1.6/theme/complete.css");
```
...
```css
@import url("https://cdn.jsdelivr.net/gh/JamsRepos/Jamfin@1.1.6/theme/base.css");
```
