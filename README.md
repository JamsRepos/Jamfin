...
```css
@import url("https://cdn.jsdelivr.net/gh/JamsRepos/Jamfin@1.3.2/theme/complete.css");
```
...
```css
@import url("https://cdn.jsdelivr.net/gh/JamsRepos/Jamfin@1.3.2/theme/base.css");
```
